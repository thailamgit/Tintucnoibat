...
if ( ! class_exists( 'WPTT_WebFont_Loader' ) ) {
	...
	class WPTT_WebFont_Loader {
		 ...
		 * @var string
		 */
		protected $newsis_stylesheet_path;
		 ...
		 * @var string
		 */
		protected $newsis_stylesheet_url;
		 ...
		 * @return string
		 */
		public function get_newsis_stylesheet_url() {
			if ( ! $this->newsis_stylesheet_url ) {
				$this->newsis_stylesheet_url = str_replace(
					$this->get_base_path(),
					$this->get_base_url(),
					$this->get_newsis_stylesheet_path()
				);
			}
			return $this->newsis_stylesheet_url;
		}
		...
		public function get_styles() {
			...
			$newsis_stylesheet_contents = $this->get_newsis_stylesheet_contents();
			if ( $newsis_stylesheet_contents ) {
				return $newsis_stylesheet_contents;
			}
			...
			$files = $this->get_newsis_files_from_css();
		 ...
		 */
		public function get_newsis_stylesheet_contents() {
			$newsis_path = $this->get_newsis_stylesheet_path();
		 ...
		 */
		public function get_newsis_files_from_css() {
		...
		protected function write_stylesheet() {
			$file_path  = $this->get_newsis_stylesheet_path();
		 ...
		 * @return string
		 */
		public function get_newsis_stylesheet_path() {
			if ( ! $this->newsis_stylesheet_path ) {
				$this->newsis_stylesheet_path = $this->get_fonts_folder() . '/' . $this->get_newsis_stylesheet_filename() . '.css';
			}
			return $this->newsis_stylesheet_path;
		}
		 ...
		 * @return string
		 */
		public function get_newsis_stylesheet_filename() {
		 ...
		 * @return bool
		 */
		public function newsis_file_exists() {
			return ( ! file_exists( $this->get_newsis_stylesheet_path() ) );
		}
		...
		public function get_base_path() {
			if ( ! $this->base_path ) {
				$this->base_path = apply_filters( 'wptt_get_newsis_fonts_base_path', $this->get_filesystem()->wp_content_dir() );
			}
		...
		public function get_base_url() {
			if ( ! $this->base_url ) {
				$this->base_url = apply_filters( 'wptt_get_newsis_fonts_base_url', content_url() );
			}
		...
		public function get_subfolder_name() {
			if ( ! $this->subfolder_name ) {
				$this->subfolder_name = apply_filters( 'wptt_get_newsis_fonts_subfolder_name', 'fonts' );
			}
