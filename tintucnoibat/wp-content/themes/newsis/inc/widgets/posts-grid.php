<?php
/**
 * Adds Newsis_Posts_Grid_Widget widget.
 * 
 * @package Newsis
 * @since 1.0.0
 */
class Newsis_Posts_Grid_Widget extends WP_Widget {
    /**
     * Register widget with WordPress.
     */
    public function __construct() {
        parent::__construct(
            'newsis_posts_grid_widget',
            esc_html__( 'Newsis : Posts Grid', 'newsis' ),
            array( 'description' => __( 'A collection of posts from specific category displayed in grid layout.', 'newsis' ) )
        );
    }
    ...
    ?>
            <div class="posts-wrap posts-grid-wrap feature-post-block <?php echo esc_attr( $widget_layout ); ?>">
                <?php
                    ...
                    ?>
                            <div class="post-item format-standard newsis-card <?php if( $widget_layout == 'layout-two'){ echo esc_attr('newsis-category-no-bk'); } ?>">
...
} // class Newsis_Posts_Grid_Widget