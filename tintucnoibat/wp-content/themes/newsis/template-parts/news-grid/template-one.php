...
extract( $args );
?>
<div id="<?php echo esc_attr( $uniqueID . ' ' . $options->blockId ); ?>" class="news-grid<?php if( isset($options->thumbOption) && ! $options->thumbOption ) echo ' section-no-thumbnail'; ?> <?php echo esc_attr( 'layout--' . $options->layout );?>">
    <?php
    ...
    <div class="news-grid-post-wrap<?php if( isset($options->column) ) { echo esc_attr( ' column--' .$options->column ); } else { echo esc_attr( ' column--one' ); }; ?>">
        <?php
